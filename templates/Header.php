...
$colorScheme = Enums\ColorSchemeType::tryFrom(Http::$Request->Cookies->Get('color-scheme') ?? Enums\ColorSchemeType::Auto->value);
$showPublicDomainDayBanner = PD_NOW > new DateTimeImmutable('January 1, 9:00 AM', SITE_TZ) && PD_NOW < new DateTimeImmutable('January 14', LATEST_CONTINENTAL_US_TZ) && !(Http::$Request->Cookies->Get('hide-public-domain-day-banner', 'bool') ?? false);
