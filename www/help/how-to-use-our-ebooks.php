<?= Template::Header(title: 'How to Use Our Ebooks', highlight: 'contribute', isManual: true, description: 'Help, tips, and tricks for using the ebook files you download from Standard Ebooks.') ?>
<main>
	<article>
				...
				<li id="kindle">
					...
					<ol>
						...
						<li>
							...
							<p><i>If you don’t see a <code class="path">system</code> folder when your Kindle is plugged in, you may have to tell your computer to show hidden system files. If you’re using Windows, you may also have to show protected operating system files. To do that, see <a href="https://www.howtogeek.com/743079/how-to-show-hidden-files-on-windows-11/">these instructions for Windows</a> and <a href="https://www.lifewire.com/display-hidden-files-in-os-x-153332">these instructions for Mac</a>. If you still don’t see the <code class="path">system</code> folder in Windows, manually enter the folder name in the File Explorer’s address bar.</i></p>
