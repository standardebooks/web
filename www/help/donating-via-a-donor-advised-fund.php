<?= Template::Header(title: 'Donating via a Donor-Advised Fund', highlight: 'donate', description: 'A guide to donating to Standard Ebooks via a Donor-Advised Fund.') ?>
<main>
	<article>
		<h1>Donating via a Donor-Advised Fund</h1>
		<p>
		...
		<section id="mailing-checks">
			...
			<ul>
				<li>
					<p>Make checks payable to Fractured Atlas.</p>
				</li>
				<li>
					<p>Include a letter stating that these funds are being donated to Fractured Atlas for the purposes of Standard Ebooks.</p>
				</li>
				<li>
					<p>Mail to Fractured Atlas at:</p>
					<address>
						Fractured Atlas<br/>
						P.O. Box 55<br/>
