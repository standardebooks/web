...
<main class="manual">
	<article class="step-by-step-guide">
		...
		<p>After an ebook production is completed, it must go through rounds of review before it is published to ensure the appropriate production quality is assured. Reviewers are assigned by the <a href="/about#editor-in-chief">editor-in-chief</a>, and may be a member of the <a href="/about#editors">editorial staff</a>, or an experienced Standard Ebooks producer. Below is a helpful step-by-step checklist for reviewers of ebook productions. The checklist is by no means exhaustive, but serves as a good starting point for the proofreading process. Reviewers should keep in mind the standards enumerated in the <a href="/manual">Manual of Style</a>, and note any discrepancies not listed below. Before any review steps, ensure the most recent version of the SE toolset is installed.</p>
				<section id="lint">
					<h2>1. Lint<a class="heading-permalink" href="#lint" aria-label="Permalink"></a></h2>
				...
				<section id="typogrify">
					<h2>2. Typogrify<a class="heading-permalink" href="#typogrify" aria-label="Permalink"></a></h2>
				...
				<section id="modernize-spelling">
					<h2>3. Modernize spelling<a class="heading-permalink" href="#modernize-spelling" aria-label="Permalink"></a></h2>
				...
				<section id="semanticate">
					<h2>4. Semanticate<a class="heading-permalink" href="#semanticate" aria-label="Permalink"></a></h2>
				...
				<section id="clean">
					<h2>5. Clean<a class="heading-permalink" href="#clean" aria-label="Permalink"></a></h2>
				...
				<section id="check-dashes-and-diacritics">
					<h2>6. Check dashes and diacritics<a class="heading-permalink" href="#check-dashes-and-diacritics" aria-label="Permalink"></a></h2>
				...
				<section id="build-title-table-of-contents-and-images">
					<h2>7. Build title, table of contents, and images<a class="heading-permalink" href="#build-title-table-of-contents-and-images" aria-label="Permalink"></a></h2>
				...
				<section id="review-initial-commit">
					<h2>8. Review initial commit<a class="heading-permalink" href="#review-initial-commit" aria-label="Permalink"></a></h2>
				...
				<section id="review-editorial-commits">
					<h2>9. Review editorial commits<a class="heading-permalink" href="#review-editorial-commits" aria-label="Permalink"></a></h2>
				...
				<section id="review-en-dash-uses">
					<h2>10. Review en dash uses<a class="heading-permalink" href="#review-en-dash-uses" aria-label="Permalink"></a></h2>
				...
				<section id="review-miscurled-quotes">
					<h2>11. Review miscurled quotes<a class="heading-permalink" href="#review-miscurled-quotes" aria-label="Permalink"></a></h2>
				...
				<p>Note the use of <code>‘</code> (left single-quotation mark, U+2018) and <code>’</code> (right single-quotation mark, U+2019) in the command above, and not <code>'</code> or <code>`</code>. Using <code class="bash"><b>se</b> interactive-replace</code> is the safest as there are many potential false positive cases here that should not be changed. Refer to the relevant section of the <a href="/manual/latest/single-page#8.7.5">Manual</a>. Note that sometimes this type of mistake might be committed by <code class="bash"><b>se</b> typogrify</code>. For example:</p>
				...
				<section id="check-for-punctuation-outside-quotation-marks">
					<h2>12. Check for punctuation outside quotation marks<a class="heading-permalink" href="#check-for-punctuation-outside-quotation-marks" aria-label="Permalink"></a></h2>
				...
				<section id="review-capitalization">
					<h2>13. Review capitalization<a class="heading-permalink" href="#review-capitalization" aria-label="Permalink"></a></h2>
				...
				<section id="review-era-abbreviation-elements">
					<h2>14. Review era abbreviation elements<a class="heading-permalink" href="#review-era-abbreviation-elements" aria-label="Permalink"></a></h2>
				...
				<section id="review-italics-and-emphasis-elements">
					<h2>15. Review italics and emphasis elements<a class="heading-permalink" href="#review-italics-and-emphasis-elements" aria-label="Permalink"></a></h2>
				...
				<section id="review-bold-and-strong-elements">
					<h2>16. Review bold and strong elements<a class="heading-permalink" href="#review-bold-and-strong-elements" aria-label="Permalink"></a></h2>
				...
				<section id="review-xhtml-file-structure">
					<h2>17. Review XHTML file structure<a class="heading-permalink" href="#review-xhtml-file-structure" aria-label="Permalink"></a></h2>
				...
				<section id="review-local-css">
					<h2>18. Review local CSS<a class="heading-permalink" href="#review-local-css" aria-label="Permalink"></a></h2>
				...
				<section id="review-colophon">
					<h2>19. Review colophon<a class="heading-permalink" href="#review-colophon" aria-label="Permalink"></a></h2>
				...
				<section id="review-metadata">
					<h2>20. Review metadata<a class="heading-permalink" href="#review-metadata" aria-label="Permalink"></a></h2>
				...
				<section id="review-cover-art">
					<h2>21. Review cover art<a class="heading-permalink" href="#review-cover-art" aria-label="Permalink"></a></h2>
				...
				<section id="lint-again">
					<h2>22. Lint again<a class="heading-permalink" href="#lint-again" aria-label="Permalink"></a></h2>
				...
				<section id="test-epub-build">
					<h2>23. Test epub build<a class="heading-permalink" href="#test-epub-build" aria-label="Permalink"></a></h2>
				...
				<section id="submit-review-comments">
					<h2>24. Submit review comments<a class="heading-permalink" href="#submit-review-comments" aria-label="Permalink"></a></h2>
