	...
	<article class="step-by-step-guide">
		...
		<details id="toc">
			...
			<ol>
				...
				<section id="a-single-collections-file">
					<h3>A single collections file<a class="heading-permalink" href="#a-single-collections-file" aria-label="Permalink"></a></h3>
...
<span class="p">&lt;/</span><span class="nt">html</span><span class="p">&gt;</span></code>
				...
				<section id="multiple-files">
					<h3>Multiple files<a class="heading-permalink" href="#multiple-files" aria-label="Permalink"></a></h3>
...
<span class="p">&lt;/</span><span class="nt">html</span><span class="p">&gt;</span></code>
				...
				<section id="manual-transcription">
					<h2>2. Manual transcription<a class="heading-permalink" href="#manual-transcription" aria-label="Permalink"></a></h2>
...
<span class="p">&lt;/</span><span class="nt">p</span><span class="p">&gt;</span></code>
				...
				<section id="modernizing-poetic-works">
					<h2>3. Modernizing poetic works<a class="heading-permalink" href="#modernizing-poetic-works" aria-label="Permalink"></a></h2>
				...
				<section id="modernize-prose-frontmatter-and-backmatter">
					<h3>Modernize prose frontmatter and backmatter<a class="heading-permalink" href="#modernize-prose-frontmatter-and-backmatter" aria-label="Permalink"></a></h3>
				...
				<section id="modernize-poems-carefully">
					<h3>Modernize poems <i>carefully</i>!<a class="heading-permalink" href="#modernize-poems-carefully" aria-label="Permalink"></a></h3>
				...
				<section id="modernization-exceptions">
					<h3>Modernization exceptions<a class="heading-permalink" href="#modernization-exceptions" aria-label="Permalink"></a></h3>
				<p>While there are no set guidelines, it’s worth noting that there are certain situations where it is advisable to preserve the original spelling. To help with this, here’s a list of specific scenarios where modernizing the spelling may be incorrect.</p>
						<section id="hyphenations-and-spacings">
							<h4>1. Hyphenations and spacings<a class="heading-permalink" href="#hyphenations-and-spacings" aria-label="Permalink"></a></h4>
						...
						<section id="mismatched-diacritics">
							<h4>2. Mismatched diacritics<a class="heading-permalink" href="#mismatched-diacritics" aria-label="Permalink"></a></h4>
...
...</code>
						...
						<section id="unusual-pronunciations">
							<h4>3. Unusual pronunciations<a class="heading-permalink" href="#unusual-pronunciations" aria-label="Permalink"></a></h4>
...
...</code>
						...
						<section id="eye-rhymes">
							<h4>4. Eye rhymes<a class="heading-permalink" href="#eye-rhymes" aria-label="Permalink"></a></h4>
...
...</code>
						...
						<section id="uncommon-contractions">
							<h4>5. Uncommon contractions<a class="heading-permalink" href="#uncommon-contractions" aria-label="Permalink"></a></h4>
...
...</code>
						...
						<section id="archaisms">
							<h4>6. Archaisms<a class="heading-permalink" href="#archaisms" aria-label="Permalink"></a></h4>
...
<span class="p">&lt;/</span><span class="nt">p</span><span class="p">&gt;</span></code>
				...
				<section id="unusual-formatting">
					<h2>4. Unusual formatting<a class="heading-permalink" href="#unusual-formatting" aria-label="Permalink"></a></h2>
				...
				<section id="numbered-stanzas">
					<h3>Numbered stanzas<a class="heading-permalink" href="#numbered-stanzas" aria-label="Permalink"></a></h3>
...
<span class="c">/* End stanza header */</span></code>
				...
				<section id="verse-paragraphs">
					<h3>Verse paragraphs<a class="heading-permalink" href="#verse-paragraphs" aria-label="Permalink"></a></h3>
				...
				<picture>
					...
					<source srcset="images/verse-paragraphs@2x.jpg 2x, images/verse-paragraphs.jpg 1x" type="image/jpeg"/>
...
<span class="p">}</span></code>
				...
				<section id="caesuras">
					<h3>Caesuras<a class="heading-permalink" href="#caesuras" aria-label="Permalink"></a></h3>
				...
				<picture>
					...
					<source srcset="images/caesuras@2x.jpg 2x, images/caesuras.jpg 1x" type="image/jpeg"/>
...
<span class="p">}</span></code>
				...
				<section id="dropped-lines">
					<h3>Dropped lines<a class="heading-permalink" href="#dropped-lines" aria-label="Permalink"></a></h3>
				...
				<picture>
					...
					<source srcset="images/dropped-lines-1@2x.jpg 2x, images/dropped-lines-1.jpg 1x" type="image/jpeg"/>
...
<span class="p">}</span></code>
				...
				<picture>
					...
					<source srcset="images/dropped-lines-2@2x.jpg 2x, images/dropped-lines-2.jpg 1x" type="image/jpeg"/>
