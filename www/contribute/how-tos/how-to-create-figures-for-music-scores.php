	...
	<article class="step-by-step-guide">
		...
		<p>Standard Ebooks handles instances of music notation in books by recreating them in a modern score editor and embedding them as SVG files much as any other illustration. To explain the process, let us consider the example of <a href="https://standardebooks.org/ebooks/george-bernard-shaw/man-and-superman"><i>Man and Superman</i></a>, which has three instances of music notation.</p>
				<section id="finding-sources">
					<h2>1. Finding sources<a class="heading-permalink" href="#finding-sources" aria-label="Permalink"></a></h2>
				...
				<section id="recreating-with-a-scorewriter">
					<h2>2. Recreating with a scorewriter<a class="heading-permalink" href="#recreating-with-a-scorewriter" aria-label="Permalink"></a></h2>
				...
				<p>MusicXML files should be named <code class="path">illustration-n.musicxml</code> and saved in <code class="path">./images/</code>. Ensure that they have a .musicxml filename. SVG files should be saved as <code class="path">illustration-n.svg</code> in <code class="path">./src/epub/images/</code>.</p>
				<aside class="tip">
				...
				<section id="edit-in-a-vector-graphics-editor">
					<h2>3. Edit in a vector graphics editor<a class="heading-permalink" href="#edit-in-a-vector-graphics-editor" aria-label="Permalink"></a></h2>
				...
				<section id="prepare-the-svg-file">
					<h2>4. Prepare the SVG file<a class="heading-permalink" href="#prepare-the-svg-file" aria-label="Permalink"></a></h2>
				...
				<section id="applying-transformations">
					<h3>Applying transformations<a class="heading-permalink" href="#applying-transformations" aria-label="Permalink"></a></h3>
				<p>As generated by MuseScore, SVG files are likely to include transform elements throughout, which need to be removed. There are several ways to do this, but the following two are recommended.</p>
				<ul>
...
<span class="p">&lt;</span><span class="nt">path</span> <span class="na">d</span><span class="o">=</span><span class="s">&quot;M 1255.14 186.95 C 1284.23 220.973 1349.96 229.301 1386.62 203.605 C 1349.09 236.19 1283.35 227.862 1255.14 186.95&quot;</span> <span class="na">stroke</span><span class="o">=</span><span class="s">&quot;#000&quot;</span> <span class="na">stroke-linecap</span><span class="o">=</span><span class="s">&quot;round&quot;</span> <span class="na">stroke-linejoin</span><span class="o">=</span><span class="s">&quot;round&quot;</span> <span class="na">stroke-width</span><span class="o">=</span><span class="s">&quot;1.74px&quot;</span><span class="p">/&gt;</span>
				...
				<section id="correcting-the-header">
					<h3>Correcting the header<a class="heading-permalink" href="#correcting-the-header" aria-label="Permalink"></a></h3>
...
<span class="p">&lt;</span><span class="nt">title</span><span class="p">&gt;</span>8 bars of musical notation for two violins, a viola, and a cello.<span class="p">&lt;/</span><span class="nt">title</span><span class="p">&gt;</span>
				...
				<section id="insert-the-music-as-a-figure-and-add-a-list-of-illustrations">
					<h2>5. Insert the music as a figure and add a List of Illustrations<a class="heading-permalink" href="#insert-the-music-as-a-figure-and-add-a-list-of-illustrations" aria-label="Permalink"></a></h2>
