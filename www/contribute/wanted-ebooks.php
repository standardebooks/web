...
<main>
	<article>
		...
		<section id="also-see">
			<h2>Also see<a class="heading-permalink" href="#uncategorized-lists" aria-label="Permalink"></a></h2>
			<ul>
				<li>
					<p><a href="/contribute/spreadsheets">Research spreadsheets for omnibuses.</a></p>
				</li>
				<li>
