		...
		<ol>
			...
			<li>
				...
				<ul>
					...
					<li>
						<p>This edition of <i>Jekyll</i> includes a table of contents <em>within the body text</em>; remove that too. S.E. ebooks place the <abbr class="initialism">ToC</abbr> in a separate file outside of the body text, where it can be displayed by the ereader software via UI elements.</p>
					</li>
					<li>
