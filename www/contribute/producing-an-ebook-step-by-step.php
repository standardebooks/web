...
proceed to seal up my confession, I bring the life of that unhappy Henry Jekyll to an end. <span class="p">&lt;/</span><span class="nt">p</span><span class="p">&gt;</span></code></figure>
				...
				<p>Each commit has an accompanying message describing the changes we are making. Please use the commit messages as they are written here in this guide as the editors rely on these words when they review the work.</p>
...
<span class="p">&lt;/</span><span class="nt">html</span><span class="p">&gt;</span></code></figure>
			...
			<li>
				...
				<aside class="alert">
					<p>Editorial changes are those where we make an editorial decision to alter the original text, for example modernizing spelling or fixing a probable printer’s typo; but not fixing a transcriber’s typo.</p>
					<p>Don’t use the [Editorial] flag for typographical changes such as hyphenation or for changing the case of letters or words.</p>
				</aside>
