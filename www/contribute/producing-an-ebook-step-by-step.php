...
<main class="manual">
	<article class="step-by-step-guide">
		...
		<ol>
			...
			<li>
				<h2>Perform the first commit</h2>
				...
				<p>Now that we’ve got the source text, we’re ready for our first commit.</p>
				<p>Please use the following commit message for consistency with the rest of our ebooks:</p>
				<code class="terminal"><span><b>git</b> add -A</span> <span><b>git</b> commit -m <i>"Initial commit"</i></span></code>
			</li>
			<li>
				<h2>Do a rough cleanup of the source text</h2>
				<p>Once we have the source text in our repository, we have to do some very broad cleanup to remove some of the cruft that comes with most Project Gutenberg transcriptions:</p>
				<ul>
					<li>
					...
					<li>
						<p>Remove “The End,” “Finis,” or other concluding footer text from the end of the book, if present.</p>
					</li>
					<li>
				...
				<p>Now our <code class="path">body.xhtml</code> file looks something like this:</p>
...
proceed to seal up my confession, I bring the life of that unhappy Henry Jekyll to an end. <span class="p">&lt;/</span><span class="nt">p</span><span class="p">&gt;</span></code></figure>
				...
				<p>Now that we’ve removed all the cruft from the top and bottom of the file, we’re ready for our next commit.</p>
				<code class="terminal"><span><b>git</b> commit -am <i>"Remove cruft"</i></span></code>
			</li>
			<li>
...
<span class="p">&lt;/</span><span class="nt">html</span><span class="p">&gt;</span></code></figure>
			...
			<li>
				<h2>Typogrify the source text and perform the third commit</h2>
				...
				<h3>The third commit</h3>
				<p>Once you’ve run <code class="bash"><b>se</b> typogrify</code> and you’ve searched the work for the common issues above, you can perform your third commit.</p><code class="terminal"><span><b>git</b> add -A</span> <span><b>git</b> commit -m <i>"Typogrify"</i></span></code>
			</li>
			<li>
			...
			<li>
				<h2>Build the manifest and spine</h2>
			...
			<li>
				<h2>Build the table of contents</h2>
			...
			<li>
				<h2>Complete the imprint and colophon</h2>
