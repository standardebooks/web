			...
			<ol class="newsletter-mailings">
				<? foreach($newsletterMailings as $newsletterMailing){ ?>
					<li>
						...
						<p><?= $newsletterMailing->SendAt->setTimezone(SITE_TZ)->format(Enums\DateTimeFormat::FullDateTime->value) ?> <?= SITE_TZ_STRING ?> • <?= Formatter::EscapeHtml($newsletterMailing->Newsletter->Name) ?></p>
