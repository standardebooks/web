...
<li id="8.1.3"><aside class="number">8.1.3</aside><p>Section titles are titlecased according to the output of <code class="bash">se titlecase</code>. Section titles are <em>not</em> all-caps or small-caps.</p></li>
...
<li id="8.3.2"><aside class="number">8.3.2</aside><p>Titlecasing, or the capitalization of titles, follows the formula used in the <code class="bash">se titlecase</code> tool.</p></li>
...
<ol type="1">
<li id="8.9.1"><aside class="number">8.9.1</aside><p>Latinisms (except _sic_) that can be found in a modern dictionary are not italicized. Examples include e.g., i.e., ad hoc, viz., ibid., etc.. The exception is _sic_, which is always italicized.</p></li>
...
<li id="8.9.4"><aside class="number">8.9.4</aside><p>For “Ibid.,” <a href="/manual/1.0.0/6-high-level-structural-patterns#6.9">see Endnotes</a>.</p></li>
