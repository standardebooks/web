...
<h3>Cover</h3>
<p>An image presenting the outer appearance of the book, usually consisting of an image, the title of the book and the author’s name. For Standard Ebooks productions, the cover is an SVG image generated from template that combines the book title and author, and a background image. The <code class="bash">se build-images</code> tool generates the cover image used for distribution.</p>
</section>
<section id="3.1.2"><aside class="number">3.1.2</aside>
<h3>Title page</h3>
<p>A page listing the title of the book and the author’s name. For Standard Ebooks productions, the title page contains an SVG image generated by the <code class="bash">se create-draft</code> tool, which is then compiled for distribution using the <code class="bash">se build-images</code> tool.</p>
</section>
