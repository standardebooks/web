...
<p>The <code class="bash"><span>se</span> lint</code> tool makes best guesses to alert the user to potential issues in an ebook production, and it may sometimes guess wrong. An <code class="path">se-lint-ignore.xml</code> file can be placed in the ebook root to make <code class="bash"><span>se</span> lint</code> ignore specific error numbers in an ebook.</p>
<ol type="1">
...
<li id="2.3.3.1"><aside class="number">2.3.3.1</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">file</span><span class="p">&gt;</span></code> elements have a <code class="html">path</code> attribute containing a filename to match in <code class="path">./src/epub/text/</code>.
...
<li id="2.3.3.2"><aside class="number">2.3.3.2</aside><p><code class="html">path</code> attributes accept shell-style globbing to match files.
...
<li id="2.3.3.3.1"><aside class="number">2.3.3.3.1</aside><p>The value of <code class="html"><span class="p">&lt;</span><span class="nt">code</span><span class="p">&gt;</span></code> is the error/warning code provided by <code class="bash"><span>se</span> lint</code>. This code will be ignored for its parent file(s) when <code class="bash"><span>se</span> lint</code> is next run.</p></li>
...
<span class="p">&lt;</span><span class="nt">se-lint-ignore</span><span class="p">&gt;</span>
	<span class="p">&lt;</span><span class="nt">file</span> <span class="na">path</span><span class="o">=</span><span class="s">"introduction.xhtml"</span><span class="p">&gt;</span>
		<span class="p">&lt;</span><span class="nt">ignore</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">code</span><span class="p">&gt;</span>t-002<span class="p">&lt;/</span><span class="nt">code</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">reason</span><span class="p">&gt;</span>Punctuation is deliberately placed outside of quotes in this ebook to prevent confusion with mathematical symbols and formulas.<span class="p">&lt;/</span><span class="nt">reason</span><span class="p">&gt;</span>
		<span class="p">&lt;/</span><span class="nt">ignore</span><span class="p">&gt;</span>
	<span class="p">&lt;/</span><span class="nt">file</span><span class="p">&gt;</span>
	<span class="p">&lt;</span><span class="nt">file</span> <span class="na">path</span><span class="o">=</span><span class="s">"tractatus-logico-philosophicus.xhtml"</span><span class="p">&gt;</span>
		<span class="p">&lt;</span><span class="nt">ignore</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">code</span><span class="p">&gt;</span>s-021<span class="p">&lt;/</span><span class="nt">code</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">reason</span><span class="p">&gt;</span>The <span class="ni">&amp;lt;</span>title<span class="ni">&amp;gt;</span> tag is accurate; the work title appears in the half title.<span class="p">&lt;/</span><span class="nt">reason</span><span class="p">&gt;</span>
		<span class="p">&lt;/</span><span class="nt">ignore</span><span class="p">&gt;</span>
		<span class="p">&lt;</span><span class="nt">ignore</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">code</span><span class="p">&gt;</span>t-002<span class="p">&lt;/</span><span class="nt">code</span><span class="p">&gt;</span>
			<span class="p">&lt;</span><span class="nt">reason</span><span class="p">&gt;</span>Punctuation is deliberately placed outside of quotes in this ebook to prevent confusion with mathematical symbols and formulas.<span class="p">&lt;/</span><span class="nt">reason</span><span class="p">&gt;</span>
