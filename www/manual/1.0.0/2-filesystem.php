...
<p>The <code class="bash">se lint</code> tool makes best guesses to alert the user to potential issues in an ebook production, and it may sometimes guess wrong. An <code class="path">se-lint-ignore.xml</code> file can be placed in the ebook root to make <code class="bash">se lint</code> ignore specific error numbers in an ebook.</p>
<ol type="1">
...
<li id="2.3.3.3.1"><aside class="number">2.3.3.3.1</aside><p>The value of <code class="html"><span class="p">&lt;</span><span class="nt">code</span><span class="p">&gt;</span></code> is the error/warning code provided by <code class="bash">se lint</code>. This code will be ignored for its parent file(s) when <code class="bash">se lint</code> is next run.</p></li>
