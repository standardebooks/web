...
<li id="7.1.4.2"><aside class="number">7.1.4.2</aside><p>Each such included parent element has the identical <code class="html">id</code> and <code class="html">epub:type</code> attributes of its real counterpart.</p></li>
</ol>
<section id="examples">
<h4>Examples</h4>
...
<li id="7.5.4"><aside class="number">7.5.4</aside><p>Indented <code class="html"><span class="p">&lt;</span><span class="nt">span</span><span class="p">&gt;</span></code> lines have the <code class="css"><span class="nt">i1</span></code> class. <i>Do not</i> use <code class="ws">nbsp</code> for indentation. Indenting to different levels is done by incrementing the class to <code class="css"><span class="nt">i2</span></code>, <code class="css"><span class="nt">i3</span></code>, and so on, and including the appropriate CSS.
...
<li id="7.5.6"><aside class="number">7.5.6</aside><p>The parent element of poetry, verse, or song, has the semantic inflection of <code class="html">z3998:poem</code>, <code class="html">z3998:verse</code>, <code class="html">z3998:song</code>, or <code class="html">z3998:hymn</code>.</p></li>
...
<h3>Dialog rows</h3>
<ol type="1">
<li id="7.6.4.1"><aside class="number">7.6.4.1</aside><p>The first child of a row of dialog is a <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> element with the semantic inflection of <code class="html">z3998:persona</code>.</p></li>
...
<li id="7.6.4.3"><aside class="number">7.6.4.3</aside><p>When several personas speak at once, or a group of personas ("The Actors") speaks at once, the containing <code class="html"><span class="p">&lt;</span><span class="nt">tr</span><span class="p">&gt;</span></code> element has the <code class="html">together</code> class, and the first <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> child has a <code class="html">rowspan</code> attribute corresponding to the number of lines spoken together.
...
<ol type="1">
<li id="7.6.6.1"><aside class="number">7.6.6.1</aside><p>The top-level element (usually <code class="html"><span class="p">&lt;</span><span class="nt">body</span><span class="p">&gt;</span></code>) has the <code class="html">z3998:drama</code> semantic inflection.</p></li>
...
<ol type="1">
<li id="7.7.1"><aside class="number">7.7.1</aside><p>Letters are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">blockquote</span><span class="p">&gt;</span></code> element with the appropriate semantic inflection, usually <code class="html">z3998:letter</code>.</p></li>
</ol>
...
<li id="7.7.2.3"><aside class="number">7.7.2.3</aside><p>The location and date of a letter have the semantic inflection of <code class="html">se:letter.dateline</code>. Dates are in a <code class="html"><span class="p">&lt;</span><span class="nt">time</span><span class="p">&gt;</span></code> element with a computer-readable date.
...
<li id="7.7.2.4"><aside class="number">7.7.2.4</aside><p>The salutation (for example, “Dear Sir” or “My dearest Jane”) has the semantic inflection of <code class="html">z3998:salutation</code>.</p></li>
...
<li id="7.7.3.3"><aside class="number">7.7.3.3</aside><p>The valediction (for example, “Yours Truly” or “With best regards”) has the semantic inflection of <code class="html">z3998:valediction</code>.</p></li>
<li id="7.7.3.4"><aside class="number">7.7.3.4</aside><p>The sender’s name has semantic inflection of <code class="html">z3998:sender</code>. If the name appears to be a signature to the letter, it has the <code class="html">signature</code> class and the corresponding <code class="css"><span class="p">.</span><span class="nc">signature</span></code> CSS.
...
<li id="7.7.3.5"><aside class="number">7.7.3.5</aside><p>Postscripts have the semantic inflection of <code class="html">z3998:postscript</code> and the following CSS:
...
<h2>Images</h2>
<ol type="1">
<li id="7.8.1"><aside class="number">7.8.1</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> elements have an <code class="html">alt</code> attribute that uses prose to describe the image in detail; this is what screen reading software will read aloud.
					</p><ol type="1">
<li id="7.8.1.1"><aside class="number">7.8.1.1</aside><p>The <code class="html">alt</code> attribute describes the visual image itself in words, which is not the same as writing a caption or describing its place in the book.
...
<li id="7.8.1.2"><aside class="number">7.8.1.2</aside><p>The <code class="html">alt</code> attribute is one or more complete sentences ended with periods or other appropriate punctuation. It is not composed of sentence fragments or complete sentences without ending punctuation.</p></li>
<li id="7.8.1.3"><aside class="number">7.8.1.3</aside><p>The <code class="html">alt</code> attribute is not necessarily the same as text in the image’s sibling <code class="html"><span class="p">&lt;</span><span class="nt">figcaption</span><span class="p">&gt;</span></code> element, if one is present.</p></li>
</ol>
</li>
<li id="7.8.2"><aside class="number">7.8.2</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> elements have semantic inflection denoting the type of image. Common values are <code class="html">z3998:illustration</code> or <code class="html">z3998:photograph</code>.</p></li>
...
<li id="7.8.4.1"><aside class="number">7.8.4.1</aside><p>When contained in a <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element, the <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element does not have an <code class="html">id</code> attribute; instead the <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element has the <code class="html">id</code> attribute.</p></li>
...
<li id="7.8.4.4"><aside class="number">7.8.4.4</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> elements that are meant to be displayed as full-page images have the <code class="html">full-page</code> class and this additional CSS:
...
<li id="7.9.2"><aside class="number">7.9.2</aside><p>The LoI file has the <code class="html">backmatter</code> semantic inflection.</p></li>
...
<li id="7.9.6"><aside class="number">7.9.6</aside><p>Links to the images go directly to the image’s corresponding <code class="html">id</code> hashes, not just the top of the containing file.</p></li>
</ol>
<section id="id5">
<h3>Examples</h3>
...
<ol type="1">
<li id="7.10.3.1"><aside class="number">7.10.3.1</aside><p>Endnotes are referenced in the text by an <code class="html"><span class="p">&lt;</span><span class="nt">a</span><span class="p">&gt;</span></code> tag with the semantic inflection <code class="html">noteref</code>.
						</p><ol type="1">
...
<li id="7.10.3.1.2"><aside class="number">7.10.3.1.2</aside><p>Noterefs have an <code class="html">id</code> attribute like <code class="html">noteref-n</code>, where <code class="html">n</code> is identical to the endnote number.</p></li>
...
<li id="7.10.4.2"><aside class="number">7.10.4.2</aside><p>The endnotes file has the <code class="html">backmatter</code> semantic inflection.</p></li>
...
<li id="7.10.4.4"><aside class="number">7.10.4.4</aside><p>Each endnote’s <code class="html">id</code> attribute is in sequential ascending order.</p></li>
</ol>
</section>
...
<li id="7.10.5.2"><aside class="number">7.10.5.2</aside><p>Each endnote’s contains a backlink, which has the semantic inflection <code class="html">backlink</code>, contains the text <code class="html">↩</code>, and has the <code class="html">href</code> attribute pointing to the corresponding noteref hash.
						</p><ol type="1">
