...
<h2>Sectioning</h2>
<ol type="1">
<li id="6.1.1"><aside class="number">6.1.1</aside><p>Major structural divisions of a larger work, like parts, volumes, books, chapters, or subchapters, are contained in a <code class="html"><span class="p">&lt;</span><span class="nt">section</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.1.2"><aside class="number">6.1.2</aside><p>Individual items in a larger collection (like a poem in a poetry collection) are contained in a <code class="html"><span class="p">&lt;</span><span class="nt">article</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.1.3"><aside class="number">6.1.3</aside><p>In <code class="html"><span class="p">&lt;</span><span class="nt">section</span><span class="p">&gt;</span></code> or <code class="html"><span class="p">&lt;</span><span class="nt">articles</span><span class="p">&gt;</span></code> elements that have titles, the first child element is an <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>–<code class="html"><span class="p">&lt;</span><span class="nt">h6</span><span class="p">&gt;</span></code> element, or a <code class="html"><span class="p">&lt;</span><span class="nt">header</span><span class="p">&gt;</span></code> element containing the section’s title.</p></li>
</ol>
<section id="6.1.4"><aside class="number">6.1.4</aside>
...
<h2>Headers</h2>
<ol type="1">
<li id="6.2.1"><aside class="number">6.2.1</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>–<code class="html"><span class="p">&lt;</span><span class="nt">h6</span><span class="p">&gt;</span></code> elements are used for headers of sections that are structural divisions of a document, i.e., divisions that appear in the table of contents. <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>–<code class="html"><span class="p">&lt;</span><span class="nt">h6</span><span class="p">&gt;</span></code> elements <em>are not</em> used for headers of components that are not in the table of contents. For example, they are not used to mark up the title of a short poem in a chapter, where the poem itself is not a structural component of the larger ebook.</p></li>
<li id="6.2.2"><aside class="number">6.2.2</aside><p>A section containing an <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>–<code class="html"><span class="p">&lt;</span><span class="nt">h6</span><span class="p">&gt;</span></code> appears in the table of contents.</p></li>
<li id="6.2.3"><aside class="number">6.2.3</aside><p>The book’s title is implicitly at the <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code> level, even if <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code> is not present in the ebook. Because of the implicit <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>, all other sections begin at <code class="html"><span class="p">&lt;</span><span class="nt">h2</span><span class="p">&gt;</span></code>.</p></li>
<li id="6.2.4"><aside class="number">6.2.4</aside><p>Each <code class="html"><span class="p">&lt;</span><span class="nt">h1</span><span class="p">&gt;</span></code>–<code class="html"><span class="p">&lt;</span><span class="nt">h6</span><span class="p">&gt;</span></code> element uses the correct number for the section’s heading level in the overall book, <em>not</em> the section’s heading level in the individual file. For example, given an ebook with a file named <code class="path">part-2.xhtml</code> containing:
...
<li id="6.2.6.2"><aside class="number">6.2.6.2</aside><p>Sections with titles but no ordinal (i.e. chapter) numbers:
...
<li id="6.2.6.3"><aside class="number">6.2.6.3</aside><p>Sections with titles and ordinal (i.e. chapter) numbers:
...
<li id="6.2.6.4"><aside class="number">6.2.6.4</aside><p>Sections titles and subtitles but no ordinal (i.e. chapter) numbers:
						</p><figure><code class="css full"><span class="nt">span</span><span class="o">[</span><span class="nt">epub</span><span class="o">|</span><span class="nt">type</span><span class="o">~=</span><span class="s2">"subtitle"</span><span class="o">]</span><span class="p">{</span>
	<span class="k">display</span><span class="p">:</span> <span class="kc">block</span><span class="p">;</span>
	<span class="k">font-weight</span><span class="p">:</span> <span class="kc">normal</span><span class="p">;</span>
<span class="p">}</span></code></figure>
...
<li id="6.2.6.5"><aside class="number">6.2.6.5</aside><p>Sections that require titles, but that are not in the table of contents:
...
<section id="6.2.7"><aside class="number">6.2.7</aside>
<h3>Bridgeheads</h3>
...
<ol type="1">
<li id="6.2.7.1"><aside class="number">6.2.7.1</aside><p>The last clause in a bridgehead ends in appropriate punctuation, like a period.</p></li>
<li id="6.2.7.2"><aside class="number">6.2.7.2</aside><p>Bridgeheads have the following CSS and HTML structure:
...
<h2>Epigraphs</h2>
<ol type="1">
<li id="6.3.1"><aside class="number">6.3.1</aside><p>All epigraphs include this CSS:
...
<section id="6.3.2"><aside class="number">6.3.2</aside>
<h3>Epigraphs in section headers</h3>
<ol type="1">
<li id="6.3.2.1"><aside class="number">6.3.2.1</aside><p>Epigraphs in section headers have the quote source in a <code class="html"><span class="p">&lt;</span><span class="nt">cite</span><span class="p">&gt;</span></code> element set in small caps, without a leading em-dash and without a trailing period.
...
<li id="6.3.2.2"><aside class="number">6.3.2.2</aside><p>In addition to the <a href="/manual/1.0.0/6-high-level-structural-patterns#6.3.1">CSS used for all epigraphs</a>, this additional CSS is included for epigraphs in section headers:
...
<section id="6.3.3"><aside class="number">6.3.3</aside>
<h3>Full-page epigraphs</h3>
<ol type="1">
<li id="6.3.3.1"><aside class="number">6.3.3.1</aside><p>In full-page epigraphs, the epigraph is centered on the page for ereaders that support advanced CSS. For all other ereaders, the epigraph is horizontally centered with a small margin above it.</p></li>
<li id="6.3.3.2"><aside class="number">6.3.3.2</aside><p>Full-page epigraphs that contain multiple quotations are represented by multiple <code class="html"><span class="p">&lt;</span><span class="nt">blockquote</span><span class="p">&gt;</span></code> elements.</p></li>
<li id="6.3.3.3"><aside class="number">6.3.3.3</aside><p>In addition to the <a href="/manual/1.0.0/6-high-level-structural-patterns#6.3.1">CSS used for all epigraphs</a>, this additional CSS is included for full-page epigraphs:
...
<li id="6.3.3.4"><aside class="number">6.3.3.4</aside><p>Example HTML:
...
<li id="6.4.4"><aside class="number">6.4.4</aside><p>Indented <code class="html"><span class="p">&lt;</span><span class="nt">span</span><span class="p">&gt;</span></code> lines have the <code class="css"><span class="nt">i1</span></code> class. <i>Do not</i> use <code class="ws">nbsp</code> for indentation. Indenting to different levels is done by incrementing the class to <code class="css"><span class="nt">i2</span></code>, <code class="css"><span class="nt">i3</span></code>, and so on, and including the appropriate CSS.
...
<li id="6.4.5"><aside class="number">6.4.5</aside><p>Poems, songs, and verse that are shorter part of a longer work, like a novel, are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">blockquote</span><span class="p">&gt;</span></code> element.
...
<h2>Plays &amp; Drama</h2>
<ol type="1">
<li id="6.5.1"><aside class="number">6.5.1</aside><p>Dialog in plays is structured using <code class="html"><span class="p">&lt;</span><span class="nt">table</span><span class="p">&gt;</span></code> elements.</p></li>
<li id="6.5.2"><aside class="number">6.5.2</aside><p>Each <code class="html"><span class="p">&lt;</span><span class="nt">tr</span><span class="p">&gt;</span></code> is either a block of dialog or a standalone stage direction.</p></li>
<li id="6.5.3"><aside class="number">6.5.3</aside><p>Works that are plays or that contain sections of dramatic dialog have this core CSS:
...
<section id="6.5.4"><aside class="number">6.5.4</aside>
<h3>Dialog rows</h3>
<ol type="1">
<li id="6.5.4.1"><aside class="number">6.5.4.1</aside><p>The first child of a row of dialog is a <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> element with the semantic inflection of <code class="html">z3998:persona</code>.</p></li>
<li id="6.5.4.2"><aside class="number">6.5.4.2</aside><p>The second child of a row of dialog is a <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> element containing the actual dialog. Elements that contain only one line of dialog do not have a block-level child (like <code class="html"><span class="p">&lt;</span><span class="nt">p</span><span class="p">&gt;</span></code>).
...
<li id="6.5.4.3"><aside class="number">6.5.4.3</aside><p>When several personas speak at once, or a group of personas ("The Actors") speaks at once, the containing <code class="html"><span class="p">&lt;</span><span class="nt">tr</span><span class="p">&gt;</span></code> element has the <code class="html">together</code> class, and the first <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> child has a <code class="html">rowspan</code> attribute corresponding to the number of lines spoken together.
...
<section id="6.5.5"><aside class="number">6.5.5</aside>
<h3>Stage direction rows</h3>
<ol type="1">
<li id="6.5.5.1"><aside class="number">6.5.5.1</aside><p>The first child of a row of stage direction is an empty <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.5.5.2"><aside class="number">6.5.5.2</aside><p>The second child of a row of dialog is a <code class="html"><span class="p">&lt;</span><span class="nt">td</span><span class="p">&gt;</span></code> element containing the stage direction</p></li>
<li id="6.5.5.3"><aside class="number">6.5.5.3</aside><p>Stage direction is wrapped in an <code class="html"><span class="p">&lt;</span><span class="nt">i</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"z3998:stage-direction"</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.5.5.4"><aside class="number">6.5.5.4</aside><p>Personas mentioned in stage direction are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">b</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"z3998:persona"</span><span class="p">&gt;</span></code> element.</p></li>
</ol>
<section id="id2">
<h4>Examples</h4>
...
<section id="6.5.6"><aside class="number">6.5.6</aside>
<h3>Works that are complete plays</h3>
<ol type="1">
<li id="6.5.6.1"><aside class="number">6.5.6.1</aside><p>The top-level element (usually <code class="html"><span class="p">&lt;</span><span class="nt">body</span><span class="p">&gt;</span></code>) has the <code class="html">z3998:drama</code> semantic inflection.</p></li>
<li id="6.5.6.2"><aside class="number">6.5.6.2</aside><p>Acts are <code class="html"><span class="p">&lt;</span><span class="nt">section</span><span class="p">&gt;</span></code> elements containing at least one <code class="html"><span class="p">&lt;</span><span class="nt">table</span><span class="p">&gt;</span></code> for dialog, and optionally containing an act title and other top-level stage direction.</p></li>
<li id="6.5.6.3"><aside class="number">6.5.6.3</aside><p>Introductory or high-level stage direction is presented using <code class="html"><span class="p">&lt;</span><span class="nt">p</span><span class="p">&gt;</span></code> elements outside of the dialog table.
...
<li id="6.5.6.4"><aside class="number">6.5.6.4</aside><p>Dramatis personae are presented as a <code class="html"><span class="p">&lt;</span><span class="nt">ul</span><span class="p">&gt;</span></code> element listing the characters.
...
<ol type="1">
<li id="6.6.1"><aside class="number">6.6.1</aside><p>Letters are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">blockquote</span><span class="p">&gt;</span></code> element with the appropriate semantic inflection, usually <code class="html">z3998:letter</code>.</p></li>
</ol>
<section id="6.6.2"><aside class="number">6.6.2</aside>
<h3>Letter headers</h3>
<ol type="1">
<li id="6.6.2.1"><aside class="number">6.6.2.1</aside><p>Parts of a letter prior to the body of the letter, for example the location where it is written, the date, and the salutation, are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">header</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.6.2.2"><aside class="number">6.6.2.2</aside><p>If there is only a salutation and no other header content, the <code class="html"><span class="p">&lt;</span><span class="nt">header</span><span class="p">&gt;</span></code> element is omitted.</p></li>
<li id="6.6.2.3"><aside class="number">6.6.2.3</aside><p>The location and date of a letter have the semantic inflection of <code class="html">se:letter.dateline</code>. Dates are in a <code class="html"><span class="p">&lt;</span><span class="nt">time</span><span class="p">&gt;</span></code> element with a computer-readable date.
...
<li id="6.6.2.4"><aside class="number">6.6.2.4</aside><p>The salutation (for example, “Dear Sir” or “My dearest Jane”) has the semantic inflection of <code class="html">z3998:salutation</code>.</p></li>
<li id="6.6.2.5"><aside class="number">6.6.2.5</aside><p>The first line of a letter after the salutation is not indented.</p></li>
<li id="6.6.2.6"><aside class="number">6.6.2.6</aside><p>Salutations that are within the first line of the letter are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">span</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"z3998:salutation</span><span class="p">&gt;</span></code> element (or a <code class="html"><span class="p">&lt;</span><span class="nt">b</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"z3998:salutation</span><span class="p">&gt;</span></code> element if small-caps are desired).
...
<li id="6.6.2.7"><aside class="number">6.6.2.7</aside><p>The name of the recipient of the letter, when set out other than within a saluation (for example a letter headed “To: John Smith Esquire”), is given the semantic inflection of <code class="html">z3998:recipient</code>. Sometimes this may occur at the end of a letter, particularly for more formal communications, in which case it is placed within a <code class="html"><span class="p">&lt;</span><span class="nt">footer</span><span class="p">&gt;</span></code> element.</p></li>
</ol>
</section>
<section id="6.6.3"><aside class="number">6.6.3</aside>
<h3>Letter footers</h3>
<ol type="1">
<li id="6.6.3.1"><aside class="number">6.6.3.1</aside><p>Parts of a letter after the body of the letter, for example the signature or postscript, are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">footer</span><span class="p">&gt;</span></code> element.</p></li>
<li id="6.6.3.2"><aside class="number">6.6.3.2</aside><p>The <code class="html">footer</code> element has the following CSS:
						</p><figure><code class="css full"><span class="nt">footer</span><span class="p">{</span>
	<span class="k">margin-top</span><span class="p">:</span> <span class="mi">1</span><span class="kt">em</span><span class="p">;</span>
	<span class="k">text-align</span><span class="p">:</span> <span class="kc">right</span><span class="p">;</span>
<span class="p">}</span></code></figure>
</li>
<li id="6.6.3.3"><aside class="number">6.6.3.3</aside><p>The valediction (for example, “Yours Truly” or “With best regards”) has the semantic inflection of <code class="html">z3998:valediction</code>.</p></li>
<li id="6.6.3.4"><aside class="number">6.6.3.4</aside><p>The sender’s name has semantic inflection of <code class="html">z3998:sender</code>. If the name appears to be a signature to the letter, it has the <code class="html">signature</code> class and the corresponding <code class="css"><span class="p">.</span><span class="nc">signature</span></code> CSS.
...
<li id="6.6.3.5"><aside class="number">6.6.3.5</aside><p>Postscripts have the semantic inflection of <code class="html">z3998:postscript</code> and the following CSS:
...
<h2>Images</h2>
<ol type="1">
<li id="6.7.1"><aside class="number">6.7.1</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> elements have an <code class="html">alt</code> attribute that uses prose to describe the image in detail; this is what screen reading software will read aloud.
					</p><ol type="1">
<li id="6.7.1.1"><aside class="number">6.7.1.1</aside><p>The <code class="html">alt</code> attribute describes the visual image itself in words, which is not the same as writing a caption or describing its place in the book.
...
<li id="6.7.1.2"><aside class="number">6.7.1.2</aside><p>The <code class="html">alt</code> attribute is one or more complete sentences ended with periods or other appropriate punctuation. It is not composed of sentence fragments or complete sentences without ending punctuation.</p></li>
<li id="6.7.1.3"><aside class="number">6.7.1.3</aside><p>The <code class="html">alt</code> attribute is not necessarily the same as text in the image’s sibling <code class="html"><span class="p">&lt;</span><span class="nt">figcaption</span><span class="p">&gt;</span></code> element, if one is present.</p></li>
</ol>
</li>
<li id="6.7.2"><aside class="number">6.7.2</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> elements have semantic inflection denoting the type of image. Common values are <code class="html">z3998:illustration</code> or <code class="html">z3998:photograph</code>.</p></li>
<li id="6.7.3"><aside class="number">6.7.3</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element whose image is black-on-white line art (i.e. exactly two colors, <strong>not</strong> grayscale!) are PNG files with a transparent background. They have the <code class="html">se:image.color-depth.black-on-transparent</code> semantic inflection.</p></li>
<li id="6.7.4"><aside class="number">6.7.4</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> elements that are meant to be aligned on the block level or displayed as full-page images are contained in a parent <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element, with an optional <code class="html"><span class="p">&lt;</span><span class="nt">figcaption</span><span class="p">&gt;</span></code> sibling.
					</p><ol type="1">
<li id="6.7.4.1"><aside class="number">6.7.4.1</aside><p>When contained in a <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element, the <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element does not have an <code class="html">id</code> attribute; instead the <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element has the <code class="html">id</code> attribute.</p></li>
<li id="6.7.4.2"><aside class="number">6.7.4.2</aside><p>An optional <code class="html"><span class="p">&lt;</span><span class="nt">figcaption</span><span class="p">&gt;</span></code> element containing a concise context-dependent caption may follow the <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element within a <code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> element. This caption depends on the surrounding context, and is not necessarily (or even ideally) identical to the <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element’s <code class="html">alt</code> attribute.</p></li>
<li id="6.7.4.3"><aside class="number">6.7.4.3</aside><p>All figure elements, regardless of positioning, have this CSS:
...
<li id="6.7.4.4"><aside class="number">6.7.4.4</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> elements that are meant to be displayed as full-page images have the <code class="html">full-page</code> class and this additional CSS:
...
<li id="6.7.4.5"><aside class="number">6.7.4.5</aside><p><code class="html"><span class="p">&lt;</span><span class="nt">figure</span><span class="p">&gt;</span></code> elements that meant to be aligned block-level with the text have this additional CSS:
...
<section id="6.8"><aside class="number">6.8</aside>
...
<section id="6.9"><aside class="number">6.9</aside>
<h2>Endnotes</h2>
<ol type="1">
<li id="6.9.1"><aside class="number">6.9.1</aside><p>Ebooks do not have footnotes, only endnotes. Footnotes are instead converted to endnotes.</p></li>
<li id="6.9.2"><aside class="number">6.9.2</aside><p>“Ibid.” is a Latinism commonly used in endnotes to indicate that the source for a quotation or reference is the same as the last-mentioned source.
...
<section id="6.9.3"><aside class="number">6.9.3</aside>
<h3>Noterefs</h3>
<p>The noteref is the superscripted number in the body text that links to the endnote at the end of the book.</p>
<ol type="1">
<li id="6.9.3.1"><aside class="number">6.9.3.1</aside><p>Endnotes are referenced in the text by an <code class="html"><span class="p">&lt;</span><span class="nt">a</span><span class="p">&gt;</span></code> tag with the semantic inflection <code class="html">noteref</code>.
						</p><ol type="1">
<li id="6.9.3.1.1"><aside class="number">6.9.3.1.1</aside><p>Noterefs point directly to the corresponding endnote <code class="html"><span class="p">&lt;</span><span class="nt">li</span><span class="p">&gt;</span></code> element in the endnotes file.</p></li>
<li id="6.9.3.1.2"><aside class="number">6.9.3.1.2</aside><p>Noterefs have an <code class="html">id</code> attribute like <code class="html">noteref-n</code>, where <code class="html">n</code> is identical to the endnote number.</p></li>
<li id="6.9.3.1.3"><aside class="number">6.9.3.1.3</aside><p>The text of the noteref is the endnote number.</p></li>
</ol>
</li>
<li id="6.9.3.2"><aside class="number">6.9.3.2</aside><p>If located at the end of a sentence, noterefs are placed after ending punctuation.</p></li>
<li id="6.9.3.3"><aside class="number">6.9.3.3</aside><p>If the endnote references an entire sentence in quotation marks, or the last word in a sentence in quotation marks, then the noteref is placed outside the quotation marks.</p></li>
</ol>
</section>
<section id="6.9.4"><aside class="number">6.9.4</aside>
<h3>The endnotes file</h3>
<ol type="1">
<li id="6.9.4.1"><aside class="number">6.9.4.1</aside><p>Endnotes are in an XHTML file located in <code class="path">./src/epub/text/endnotes.xhtml</code>.</p></li>
<li id="6.9.4.2"><aside class="number">6.9.4.2</aside><p>The endnotes file has the <code class="html">backmatter</code> semantic inflection.</p></li>
<li id="6.9.4.3"><aside class="number">6.9.4.3</aside><p>The endnotes file contains a single <code class="html"><span class="p">&lt;</span><span class="nt">section</span> <span class="na">id</span><span class="o">=</span><span class="s">"endnotes"</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"endnotes"</span><span class="p">&gt;</span></code> element, which in turn contains an <code class="html"><span class="p">&lt;</span><span class="nt">h2</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"title"</span><span class="p">&gt;</span>Endnotes<span class="p">&lt;/</span><span class="nt">h2</span><span class="p">&gt;</span></code> element, followed by an <code class="html"><span class="p">&lt;</span><span class="nt">ol</span><span class="p">&gt;</span></code> element containing list items representing the endnotes.</p></li>
<li id="6.9.4.4"><aside class="number">6.9.4.4</aside><p>Each endnote’s <code class="html">id</code> attribute is in sequential ascending order.</p></li>
</ol>
</section>
<section id="6.9.5"><aside class="number">6.9.5</aside>
<h3>Individual endnotes</h3>
<ol type="1">
<li id="6.9.5.1"><aside class="number">6.9.5.1</aside><p>An endnote is an <code class="html"><span class="p">&lt;</span><span class="nt">li</span> <span class="na">id</span><span class="o">=</span><span class="s">"note-n"</span> <span class="na">epub:type</span><span class="o">=</span><span class="s">"endnote"</span><span class="p">&gt;</span></code> element containing one or more block-level text elements and one backlink element.</p></li>
<li id="6.9.5.2"><aside class="number">6.9.5.2</aside><p>Each endnote’s contains a backlink, which has the semantic inflection <code class="html">backlink</code>, contains the text <code class="html">↩</code>, and has the <code class="html">href</code> attribute pointing to the corresponding noteref hash.
						</p><ol type="1">
<li id="6.9.5.2.1"><aside class="number">6.9.5.2.1</aside><p>In endnotes where the last block-level element is a <code class="html"><span class="p">&lt;</span><span class="nt">p</span><span class="p">&gt;</span></code> element, the backlink goes at the end of the <code class="html"><span class="p">&lt;</span><span class="nt">p</span><span class="p">&gt;</span></code> element, preceded by exactly one space.</p></li>
<li id="6.9.5.2.2"><aside class="number">6.9.5.2.2</aside><p>In endnotes where the last block-level element is verse, quotation, or otherwise not plain prose text, the backlink goes in its own <code class="html"><span class="p">&lt;</span><span class="nt">p</span><span class="p">&gt;</span></code> element following the last block-level element in the endnote.</p></li>
</ol>
</li>
<li id="6.9.5.3"><aside class="number">6.9.5.3</aside><p>Endnotes with ending citations have those citations are wrapped in a <code class="html"><span class="p">&lt;</span><span class="nt">cite</span><span class="p">&gt;</span></code> element, including any em-dashes. A space follows the <code class="html"><span class="p">&lt;</span><span class="nt">cite</span><span class="p">&gt;</span></code> element, before the backlink.</p></li>
</ol>
</section>
<section id="id6">
<h3>Examples</h3>
