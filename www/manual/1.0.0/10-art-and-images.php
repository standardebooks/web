...
<h2>SVG patterns</h2>
<ol type="1">
<li id="10.2.1"><aside class="number">10.2.1</aside><p>SVGs are only sized with <code class="html">viewBox</code>, not <code class="html">height</code> or <code class="html">width</code>.
					</p><ol type="1">
<li id="10.2.1.1"><aside class="number">10.2.1.1</aside><p>The <code class="html">viewBox</code> attribute consists of whole numbers, without fractions.</p></li>
</ol>
</li>
<li id="10.2.2"><aside class="number">10.2.2</aside><p>The only attributes on the <code class="html"><span class="p">&lt;</span><span class="nt">svg</span><span class="p">&gt;</span></code> root element are: <code class="html">xmlns</code>, <code class="html">version</code>, and <code class="html">viewBox</code>.</p></li>
<li id="10.2.3"><aside class="number">10.2.3</aside><p>The contents of the SVG’s <code class="html"><span class="p">&lt;</span><span class="nt">title</span><span class="p">&gt;</span></code> element matches the <code class="html">alt</code> attribute of its <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element in the text.</p></li>
...
<li id="10.2.6"><aside class="number">10.2.6</aside><p>The <code class="html">transform</code> attribute is illegal; transforms are applied to their elements directly.</p></li>
</ol>
</section>
