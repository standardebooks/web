...
<section id="10.2"><aside class="number">10.2</aside>
<h2>SVG patterns</h2>
<ol type="1">
<li id="10.2.1"><aside class="number">10.2.1</aside><p>SVGs are only sized with <code class="html"><span class="na">viewBox</span></code>, not <code class="html"><span class="na">height</span></code> or <code class="html"><span class="na">width</span></code>.
					</p><ol type="1">
<li id="10.2.1.1"><aside class="number">10.2.1.1</aside><p>The <code class="html"><span class="na">viewBox</span></code> attribute consists of whole numbers, without fractions.</p></li>
</ol>
<aside class="tip">The <code class="html"><span class="na">viewBox</span></code> attribute is case-sensitive!</aside>
</li>
<li id="10.2.2"><aside class="number">10.2.2</aside><p>The only attributes on the <code class="html"><span class="p">&lt;</span><span class="nt">svg</span><span class="p">&gt;</span></code> root element are: <code class="html"><span class="na">xmlns</span></code>, <code class="html"><span class="na">version</span></code>, and <code class="html"><span class="na">viewBox</span></code>.</p></li>
<li id="10.2.3"><aside class="number">10.2.3</aside><p>The contents of the SVG’s <code class="html"><span class="p">&lt;</span><span class="nt">title</span><span class="p">&gt;</span></code> element matches the <code class="html"><span class="na">alt</span></code> attribute of its <code class="html"><span class="p">&lt;</span><span class="nt">img</span><span class="p">&gt;</span></code> element in the text.</p></li>
<li id="10.2.4"><aside class="number">10.2.4</aside><p>Grouping with <code class="html"><span class="p">&lt;</span><span class="nt">g</span><span class="p">&gt;</span></code> is avoided, unless it makes semantic sense. Groups whose sole purpose is to apply transforms should have those transforms applied to the children, and the group removed.</p></li>
<li id="10.2.5"><aside class="number">10.2.5</aside><p>The use of fill color is avoided unless strictly necessary. Not defining a fill color allows for night mode compatibility.</p></li>
<li id="10.2.6"><aside class="number">10.2.6</aside><p>The <code class="html"><span class="na">transform</span></code> attribute is illegal; transforms are applied to their elements directly.</p></li>
</ol>
</section>
<section id="10.3"><aside class="number">10.3</aside>
...
<ol type="1">
<li id="10.3.1"><aside class="number">10.3.1</aside><p>The <code class="html"><span class="p">&lt;</span><span class="nt">title</span><span class="p">&gt;</span></code> element has a value of <code class="string">The cover for the Standard Ebooks edition of</code> followed by the <a href="/manual/1.0.0/6-standard-ebooks-section-patterns#6.1">title string</a>.</p></li>
</ol>
...
<ol type="1">
<li id="10.4.1"><aside class="number">10.4.1</aside><p>The <code class="html"><span class="p">&lt;</span><span class="nt">title</span><span class="p">&gt;</span></code> element has a value of <code class="string">The titlepage for the Standard Ebooks edition of</code> followed by the <a href="/manual/1.0.0/6-standard-ebooks-section-patterns#6.1">title string</a>.</p></li>
</ol>
...
<li id="10.4.2.3"><aside class="number">10.4.2.3</aside><p>Names of contributors besides the author are preceded by <code class="string">translated by</code> or <code class="string">illustrated by</code>. <code class="string">translated by</code> and <code class="string">illustrated by</code> are set in lowercase Sorts Mill Goudy Italic font.</p></li>
...
<ol type="1">
<li id="10.4.2.10.1"><aside class="number">10.4.2.10.1</aside><p>“Contributors” are a “contributor descriptor,” like <code class="string">translated by</code>, followed by the contributor name on a new line.</p></li>
