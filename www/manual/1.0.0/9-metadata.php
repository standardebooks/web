...
<p>Follow the general structure of the <code class="path">content.opf</code> file generated by <code class="bash"><b>se</b> create-draft</code>. Don’t rearrange the order of anything in there.</p>
...
<p>(Note: Strings can be made URL-safe using the <code class="bash"><b>se</b> make-url-safe</code> tool.)</p>
<ul>
...
<p>There are several elements in the metadata describing the publication date, updated date, and revision number of the ebook. Generally these are not updated by hand; instead, the <code class="bash"><b>se</b> prepare-release</code> tool updates them automatically.</p>
<ol type="1">
...
<li id="9.4.2.4"><aside class="number">9.4.2.4</aside><p>All three <code class="html"><span class="p">&lt;</span><span class="nt">dc:title</span><span class="p">&gt;</span></code> elements have an accompanying <code class="html"><span class="p">&lt;</span><span class="nt">meta</span> <span class="na">property</span><span class="o">=</span><span class="s">"file-as"</span><span class="p">&gt;</span></code> element, even if the <code class="bash"><span class="s">file-as</span></code> value is the same as the title.</p></li>
</ol>
<figure><code class="html full"><span class="p">&lt;</span><span class="nt">dc:title</span> <span class="na">id</span><span class="o">=</span><span class="s">"title"</span><span class="p">&gt;</span>The Moon Pool<span class="p">&lt;/</span><span class="nt">dc:title</span><span class="p">&gt;</span>
<span class="p">&lt;</span><span class="nt">meta</span> <span class="na">property</span><span class="o">=</span><span class="s">"file-as"</span> <span class="na">refines</span><span class="o">=</span><span class="s">"#title"</span><span class="p">&gt;</span>Moon Pool, The<span class="p">&lt;/</span><span class="nt">meta</span><span class="p">&gt;</span></code></figure>
...
<ol type="1">
<li id="9.5.1.1"><aside class="number">9.5.1.1</aside><p>Each <code class="html"><span class="p">&lt;</span><span class="nt">dc:subject</span><span class="p">&gt;</span></code> has the <code class="html"><span class="na">id</span></code> attribute set to <code class="bash"><span class="s">subject-#</span></code>, where # is a number starting at <code class="bash"><span class="s">1</span></code>, without leading zeros, that increments with each subject.</p></li>
...
<ol type="1">
<li id="9.5.2.4.1"><aside class="number">9.5.2.4.1</aside><p>Ebooks that are collections of short stories have the SE subject <code class="string">Shorts</code> as one of the SE subjects.</p></li>
<li id="9.5.2.4.2"><aside class="number">9.5.2.4.2</aside><p>Ebooks that are young adult or children’s books have the SE subject <code class="string">Childrens</code> as one of the SE subjects.</p></li>
</ol>
</section>
</section>
</section>
...
<li id="9.6.2.3"><aside class="number">9.6.2.3</aside><p>The long description is in <em>escaped</em> HTML, with the HTML beginning on its own line after the <code class="html"><span class="p">&lt;</span><span class="nt">meta</span> <span class="na">property</span><span class="o">=</span><span class="s">"se:long-description"</span><span class="p">&gt;</span></code> element.
						<aside class="tip">An easy way to escape HTML is to compose the long description in regular HTML, then insert it into the <code class="html"><span class="p">&lt;</span><span class="nt">meta</span> <span class="na">property</span><span class="o">=</span><span class="s">"se:long-description"</span><span class="p">&gt;</span></code> element surrounded by a <code class="html"><span class="cp">&lt;![CDATA[ ... ]]&gt;</span></code> element. Then, run the <code class="bash"><b>se</b> clean</code> tool, which will remove the <code class="html"><span class="cp">&lt;![CDATA[ ... ]]&gt;</span></code> element and escape the contained HTML.</aside>
</p></li>
...
<h2>Book language</h2>
<ol type="1">
<li id="9.7.1"><aside class="number">9.7.1</aside><p>The <code class="html"><span class="p">&lt;</span><span class="nt">dc:language</span><span class="p">&gt;</span></code> element follows the long description block. It contains the <a href="https://en.wikipedia.org/wiki/IETF_language_tag">IETF language tag</a> for the language that the work is in. Usually this is either <code class="html"><span class="na">en-US</span></code> or <code class="html"><span class="na">en-GB</span></code>.</p></li>
</ol>
</section>
...
<p>These two elements are automatically computed by the <code class="bash"><b>se</b> prepare-release</code> tool.</p>
<ol type="1">
...
<li id="9.11.2"><aside class="number">9.11.2</aside><p>If there is more than one author, the first author’s <code class="html"><span class="na">id</span></code> is <code class="bash"><span class="s">author-1</span></code>, the second <code class="bash"><span class="s">author-2</span></code>, and so on.</p></li>
...
<li id="9.12.2"><aside class="number">9.12.2</aside><p>If there is more than one translator, then the first translator’s <code class="html"><span class="na">id</span></code> is <code class="bash"><span class="s">translator-1</span></code>, the second <code class="bash"><span class="s">translator-2</span></code>, and so on.</p></li>
...
<li id="9.13.2"><aside class="number">9.13.2</aside><p>If there is more than one illustrator, the first illustrator’s <code class="html"><span class="na">id</span></code> is <code class="bash"><span class="s">illustrator-1</span></code>, the second <code class="bash"><span class="s">illustrator-2</span></code>, and so on.</p></li>
...
<li id="9.16.2"><aside class="number">9.16.2</aside><p>If the transcriber is anonymous, the value for the producer’s <code class="html"><span class="p">&lt;</span><span class="nt">dc:contributor</span><span class="p">&gt;</span></code> element is <code class="string">An Anonymous Volunteer</code>.</p></li>
<li id="9.16.3"><aside class="number">9.16.3</aside><p>If there is more than one transcriber, the first transcriber is <code class="bash"><span class="s">transcriber-1</span></code>, the second <code class="bash"><span class="s">transcriber-2</span></code>, and so on.</p></li>
...
<ol type="1">
<li id="9.17.1"><aside class="number">9.17.1</aside><p>If there is more than one producer, the first producer is <code class="bash"><span class="s">producer-1</span></code>, the second <code class="bash"><span class="s">producere-2</span></code>, and so on.</p></li>
...
<li id="9.17.3"><aside class="number">9.17.3</aside><p>If a producer is anonymous, the value for the producer’s <code class="html"><span class="p">&lt;</span><span class="nt">dc:contributor</span><span class="p">&gt;</span></code> element is <code class="string">Anonymous</code>.</p></li>
...
<li><p><code class="string">bkp</code>: The producer produced the ebook.</p></li>
<li><p><code class="string">blw</code>: The producer wrote the blurb (the long description).</p></li>
<li><p><code class="string">cov</code>: The producer selected the cover art.</p></li>
<li><p><code class="string">mrk</code>: The producer wrote the HTML markup for the ebook.</p></li>
<li><p><code class="string">pfr</code>: The producer proofread the ebook.</p></li>
<li><p><code class="string">tyg</code>: The producer reviewed the typography of the ebook.</p></li>
</ul>
</li>
</ol>
</section>
...
<aside class="tip">The <code class="bash"><b>se</b> print-manifest-and-spine</code> tool generates a complete manifest that can be copied-and-pasted into the ebook’s metadata file.</aside>
<ol type="1">
<li id="9.18.1"><aside class="number">9.18.1</aside><p>The manifest is in alphabetical order.</p></li>
<li id="9.18.2"><aside class="number">9.18.2</aside><p>The <code class="html"><span class="na">id</span></code> attribute is the basename of the <code class="html"><span class="na">href</span></code> attribute.</p></li>
<li id="9.18.3"><aside class="number">9.18.3</aside><p>Files which contain SVG images have the additional <code class="html"><span class="na">properties</span></code> attribute with the value <code class="bash"><span class="s">svg</span></code> in their manifest item.</p></li>
<li id="9.18.4"><aside class="number">9.18.4</aside><p>The manifest item for the table of contents file has the additional <code class="html"><span class="na">properties</span></code> attribute with the value <code class="bash"><span class="s">nav</span></code>.</p></li>
<li id="9.18.5"><aside class="number">9.18.5</aside><p>The manifest item for the cover image has the additional <code class="html"><span class="na">properties</span></code> attribute with the value <code class="bash"><span class="s">cover-image</span></code>.</p></li>
</ol>
</section>
...
<aside class="tip">The <code class="bash"><b>se</b> print-manifest-and-spine</code> tool generates a draft of the spine by making some educated guesses as to the reading order. The tool’s output is never 100% correct; manual review of the output is required, and adjustments may be necessary to correct the reading order.</aside>
</section>
</section>
		</article>
	</main>
