...
<li id="5.1.2.3"><aside class="number"><a href="#5.1.2.3">5.1.2.3</a></aside><p>If an element that is not a <code class="html"><span class="p">&lt;</span><span class="nt">section</span><span class="p">&gt;</span></code> or <code class="html"><span class="p">&lt;</span><span class="nt">article</span><span class="p">&gt;</span></code> requires an <code class="html"><span class="na">id</span></code> attribute, the attribute’s value is the name of the element followed by <code class="bash"><span class="s">-N</span></code>, where <code class="bash"><span class="s">N</span></code> is the sequence number of the element start at <code class="bash"><span class="s">1</span></code>.
