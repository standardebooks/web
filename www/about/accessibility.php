...
<main>
	<section class="accessibility narrow">
		...
		<section id="ebooks">
			<h2>Our ebooks<a class="heading-permalink" href="#ebooks" aria-label="Permalink"></a></h2>
		...
		<section id="website">
			<h2>Our website<a class="heading-permalink" href="#website" aria-label="Permalink"></a></h2>
		...
		<section id="support">
			<h2>Support<a class="heading-permalink" href="#support" aria-label="Permalink"></a></h2>
