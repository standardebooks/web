...
foreach($ebooks as $ebook){
	...
	switch($ebook->Identifier){
		...
		case 'url:https://standardebooks.org/ebooks/ernest-hemingway/a-farewell-to-arms':
			$description = '<p>Called “the premier American war novel from World War I,” Hemingway’s semi-autobiographical story of an American ambulance driver serving in the Italian front, and a bright and cynical British nurse, cemented his reputation as one of the generation’s foremost literary figures. Unlike Remarque, whose <i>All Quite on the Western Front</i> paints the war’s destruction in full color, Hemingway’s story is one of the mundanity of war—of the quotidien smallness that underpins even the most horrific of events.</p>';
			$order = 2;
			break;
		case 'url:https://standardebooks.org/ebooks/john-steinbeck/cup-of-gold':
			$description = '<p><i>Cup of Gold</i> is John Steinbeck’s first novel, the swashbuckling story of the real-life Captain Morgan, legendary pirate. Little of Morgan’s actual life is known, but Steinbeck fills in the blanks of this rich historical fiction with rich portraits of Caribbean ports and flourishes of magical realism.</p><p>While one might expect a rollicking tale of adventure, the novel is actually a deep meditation on the pursuit of—and inability to find—true happiness, and its skillful craft deftly foreshadows Steinbeck’s later ascenion to literary titanhood.</p>';
			$order = 3;
			break;
		...
		case 'url:https://standardebooks.org/ebooks/calvin-coolidge/the-autobiography-of-calvin-coolidge':
			$description = '<p>Calvin Coolidge was the 30th president of the United States, entering the office as vice president when president Warren G. Harding suddenly passed, and winning a reelection term. Even though he was hugely popular, he declined running for a second full term, opting to retire instead. In this autobiography—which is as brief as “Silent Cal’s” legend suggests it might be—we follow the former president from his idyllic boyhood in Vermont, to a career in the law, to the governership of Massachussetts, to the presidency and beyond.</p>';
			$order = 8;
			break;
		...
		case 'url:https://standardebooks.org/ebooks/c-s-forester/brown-on-resolution':
			$description = '<p>While on operations in the Pacific during the first World War, the sailor Albert Brown’s ship is sunk—but he survives, and is taken on board the German cruiser that sank them. It too has suffered damage, and heads to some nearby islands for repairs. In this unlikely and hostile setting, Brown, alone, pits himself against the German ship and its crew, seeking to delay its progress while British naval reinforcements rush to his rescue.</p><p>Forester’s careful historical research adds an unimpeachable air of versimilitude to the novel, and indeed, the plot is loosely based on real events.</p>';
			$order = 14;
			break;
