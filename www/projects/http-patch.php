...
try{
	...
	// If an admin set this `Project` to `abandoned`, unassign the `Artwork`.
	if($project->Status == Enums\ProjectStatusType::Abandoned && $originalProjectStatus != Enums\ProjectStatusType::Abandoned){
		$project->UnassignArtwork();
	}
